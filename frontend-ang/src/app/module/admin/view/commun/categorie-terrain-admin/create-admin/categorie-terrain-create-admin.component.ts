...
@Component({
  selector: 'app-categorie-terrain-create-admin',
  templateUrl: './categorie-terrain-create-admin.component.html'
})
export class CategorieTerrainCreateAdminComponent extends AbstractCreateController<CategorieTerrainDto, CategorieTerrainCriteria, CategorieTerrainService>  implements OnInit {
